...
local function ensure_layer_list()
    ...
    layer_keys = {}
    layer_values = {}
    for k in pairs(core.object.layer) do
        table.insert(layer_keys, k)
    end
    table.sort(layer_keys, function(a, b)
        return core.object.layer[a] < core.object.layer[b]
    end)
    for i, k in ipairs(layer_keys) do
        layer_values[i] = core.object.layer[k]
    end
end
...
function Frame_Data_Setter:layout_frame_groups()
    ...
    for k, v in pairs(core.object.group) do
