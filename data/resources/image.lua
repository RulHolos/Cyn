...
---Renders a image to fill the entire screen. Equivalent to `render_rect(0, core.screen.LANDSCAPE_W, 0, core.screen.LANDSCAPE_H)`.
function M:render_screen()
    self:render_rect(0, core.screen.LANDSCAPE_W, 0, core.screen.LANDSCAPE_H)
end
