...
---@field timer integer
---@field init fun(self:cyn.stage)
---@field frame fun(self:cyn.stage)
---@field render fun(self:cyn.stage)
---@field del fun(self:cyn.stage)
local _s = {
    type = "stage",
    name = "",
    is_menu = false,
...
---@param stage cyn.stage
---@return cyn.stage @self
---@private
...
---@param target cyn.stage|cyn.stage_group|nil
---@private
