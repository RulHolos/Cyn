...
---
---.cdf files are validated using cyn.cdf.invalidate. Any subsequent access to them will get fresh data.
---
---Any other file triggers cyn.hot_reload.on_change events.
---
